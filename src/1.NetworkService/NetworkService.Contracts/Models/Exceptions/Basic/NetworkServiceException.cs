...
namespace NetworkService.Contracts.Models.Exceptions.Basic
{
    public class NetworkServiceException : Exception
    {
        ...
        public NetworkServiceException(Exception exception) : base(Message, exception) { }

        public NetworkServiceException(string message, Exception exception) : base(message, exception) { }
